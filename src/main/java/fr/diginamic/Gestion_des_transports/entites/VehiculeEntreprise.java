...
public class VehiculeEntreprise extends Vehicule {
    ...
    public VehiculeEntreprise(int id, String immatriculation, Integer nbPlaces, String modele, Integer co2ParKm, String photo, String marque, Motorisation motorisation, Categorie categorie, StatutVehicule statut) {
